...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    ...
    // ⏳ Watchdog: evita pantalla pegada en loading eterno
    const watchdog = setTimeout(() => {
      console.warn("⏳ [AuthContext] Timeout: liberando loading para evitar pantalla pegada.");
    ...
    const inicializarSesion = async () => {
      ...
      try {
        ...
        if (session?.user && mounted) {
          ...
          if (perfil) {
            console.log("👍 [AuthContext] Usuario y rol OK.");
